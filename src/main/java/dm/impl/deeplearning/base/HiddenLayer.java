package dm.impl.deeplearning.base;

import java.util.Random;
import java.util.function.DoubleFunction;

import static dm.impl.deeplearning.base.utils.*;
