...
public class Winamodel_rate_sort_baidu extends WinaBaseModel implements WinaInterface {
    private static Winamodel_rate_sort_baidu instance;
    private ReentrantReadWriteLock rwl = new ReentrantReadWriteLock();

    public static synchronized Winamodel_rate_sort_baidu getInstance(String file_path,HashMap<String,HashMap<String,List>> id) throws IOException {
        if(instance==null)
            instance = new Winamodel_rate_sort_baidu(id);
        return instance;
    }

    public static synchronized Winamodel_rate_sort_baidu getInstance(String file_path, String mode) throws Exception {
        if(instance==null)
            instance = new Winamodel_rate_sort_baidu(mode);
        return instance;
    }


    public Winamodel_rate_sort_baidu(HashMap<String,HashMap<String,List>> id) throws IOException{
    ...
    public Winamodel_rate_sort_baidu(String mode) throws IOException {
        super(mode);
