...
public class Winamodel_rate_controlBaiduDisplay extends WinaBaseModel implements WinaInterface {
    private static Winamodel_rate_controlBaiduDisplay instance;
    ...
    public static synchronized Winamodel_rate_controlBaiduDisplay getInstance(String file_path, HashMap<String,HashMap<String,List>> id) throws Exception {
        if(instance==null)
            instance = new Winamodel_rate_controlBaiduDisplay(id);
        return instance;
    }

    public static synchronized Winamodel_rate_controlBaiduDisplay getInstance(String file_path, String mode) throws Exception {
        if(instance==null)
            instance = new Winamodel_rate_controlBaiduDisplay(mode);
        return instance;
    }

    public Winamodel_rate_controlBaiduDisplay(HashMap<String,HashMap<String,List>> id) throws IOException {
    ...
    public Winamodel_rate_controlBaiduDisplay(String mode) throws IOException {
        super(mode);
