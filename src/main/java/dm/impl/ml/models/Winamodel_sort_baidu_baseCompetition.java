...
public class Winamodel_sort_baidu_baseCompetition extends WinaBaseModel implements WinaInterface {
    private static Winamodel_sort_baidu_baseCompetition instance;
    ...
    public static synchronized Winamodel_sort_baidu_baseCompetition getInstance(String file_path,HashMap<String,HashMap<String,List>> id) throws IOException {
        if(instance==null)
            instance = new Winamodel_sort_baidu_baseCompetition(id);
        return instance;
    }

    public static synchronized Winamodel_sort_baidu_baseCompetition getInstance(String file_path, String mode) throws Exception {
        if(instance==null)
            instance = new Winamodel_sort_baidu_baseCompetition(mode);
        return instance;
    }


    public Winamodel_sort_baidu_baseCompetition(HashMap<String,HashMap<String,List>> id) throws IOException{
    ...
    public Winamodel_sort_baidu_baseCompetition(String mode) throws IOException {
        super(mode);
