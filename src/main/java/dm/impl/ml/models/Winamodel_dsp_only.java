...
public class Winamodel_dsp_only extends WinaBaseModel implements WinaInterface {
    private static Winamodel_dsp_only instance;
    public static synchronized Winamodel_dsp_only getInstance(String file_path,HashMap<String,HashMap<String,List>> id) throws Exception {

        if(instance==null)
            instance = new Winamodel_dsp_only(id);
        return instance;
    }

    public static synchronized Winamodel_dsp_only getInstance(String file_path,String mode) throws Exception {
        if(instance==null)
            instance = new Winamodel_dsp_only(mode);
        return instance;
    }

    public Winamodel_dsp_only(HashMap<String,HashMap<String,List>> id) throws IOException {

        imeikeyword=id.get("imeikeyword");
        androidkeyword=id.get("androidkeyword");
    }

    public Winamodel_dsp_only(String mode) throws IOException {
        super(mode);
    }
