...
public class Winamodel_rate_sort_baidu_competition extends WinaBaseModel implements WinaInterface {
    private static Winamodel_rate_sort_baidu_competition instance;
    ...
    public static synchronized Winamodel_rate_sort_baidu_competition getInstance(String file_path,HashMap<String,HashMap<String,List>> id) throws IOException {
        if(instance==null)
            instance = new Winamodel_rate_sort_baidu_competition(id);
        return instance;
    }

    public static synchronized Winamodel_rate_sort_baidu_competition getInstance(String file_path, String mode) throws Exception {
        if(instance==null)
            instance = new Winamodel_rate_sort_baidu_competition(mode);
        return instance;
    }


    public Winamodel_rate_sort_baidu_competition(HashMap<String,HashMap<String,List>> id) throws IOException{
    ...
    public Winamodel_rate_sort_baidu_competition(String mode) throws IOException {
        super(mode);
            ...
            for (int i=0;i<adlist.length();i++){
                ...
                if (htt[0].contains("cpro")){
                    ...
                    if (con==1){
                        ...
                        p=1/(con*((2*price*compit)+0.00000001));
                    }
                }else{
                    p=-2*con;
                }
